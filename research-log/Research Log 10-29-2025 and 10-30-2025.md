...
5. Try to change my  current network code to match a GCNN model? I should probably test my current code for the current dataset to check if an analysis of the dataset can be done given the right impelementation.
